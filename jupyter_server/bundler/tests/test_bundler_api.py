...
class BundleAPITest(ServerTestBase):
    ...
    def test_bundler_import_error(self):
        ...
        with patch('jupyter_server.bundler.handlers.BundlerHandler.get_bundler') as mock:
    ...
    def test_bundler_invoke(self):
        ...
        with patch('jupyter_server.bundler.handlers.BundlerHandler.get_bundler') as mock:
            mock.return_value = {'module_name': 'jupyter_server.bundler.tests.test_bundler_api'}
            resp = self.request('GET', 'bundle/testnb.ipynb',
