...
class ServerWebApplication(web.Application):
    ...
    def init_handlers(self, settings):
        ...
        handlers.extend(load_handlers('jupyter_server.services.view.handlers'))
        ...
        handlers.extend(load_handlers('jupyter_server.services.nbconvert.api_handlers'))
        handlers.extend(load_handlers('jupyter_server.services.kernelspecs.api_handlers'))
